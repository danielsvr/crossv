...
public class DivideExpressionTests {
	...
	@Test
	public void parseDivideExpression_1And2_LeftConstantIs1() {
		Divide e = Divide.parse("1 / 2");
		Constant constant = (Constant) e.getLeft();
		assertThat(constant.getValue(), is(equalTo(1)));
	}

	@Test
	public void parseDivideExpression_1And2_RightConstantIs2() {
		Divide e = Divide.parse("1 / 2");
	...
	@Test
	public void evaluatingAParsedDivideExpression_1And2f_Retuns0()
			throws Exception {
		Expression e = Divide.parse("1 / 2f");
		assertThat(e.evaluate(), is(equalTo(0.5f)));
	}

	@Test
	public void evaluatingAParsedDivideExpression_1And2_Retuns0()
			throws Exception {
		Expression e = Divide.parse("1 / 2");
